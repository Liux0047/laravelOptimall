...
function enableSubmit() {
    if ($("#login_email_mobile").val() && $("#login_password").val()) {
...
function auth_login() {
    ...
    var emailMobile = document.getElementById("login_email_mobile").value;
    ...
    $.ajax({
        ...
        data: {email_mobile: emailMobile, password: password, remember_me: remember_me}
    }).done(function(data) {
